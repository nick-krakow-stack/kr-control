        ...
        <div class="px-3 py-4 border-t border-slate-800">
          <div class="flex items-center gap-3 px-3 py-2 mb-2">
            ...
            <div class="flex-1 min-w-0">
              <div class="text-white text-xs font-medium truncate">KR Control Admin</div>
...
export function setActiveNav(hash) {
  // Normalize: /cases/new and /cases/123 should highlight /cases
  const activeHash = hash === "#/cases/new" ? "#/cases/new" : hash.replace(/#\/cases\/\d+$/, "#/cases");
