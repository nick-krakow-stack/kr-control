    ...
    <div class="p-6 lg:p-8 max-w-7xl mx-auto">
      <div class="flex items-center justify-between mb-6">
        <div>
          ...
          <p class="text-slate-500 text-sm mt-1">Alle gemeldeten Falschparker</p>
        </div>
        <a href="#/cases/new"
      ...
      <div class="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 mb-4">
        <div class="flex flex-wrap gap-3">
          ...
          <select id="filterStatus" class="input w-auto min-w-40">
            <option value="">Alle Status</option>
            <option value="new">Neu</option>
            <option value="in_progress">In Bearbeitung</option>
            <option value="ticket_issued">Ticket ausgestellt</option>
            <option value="ordnungsamt">Ordnungsamt angefragt</option>
            <option value="letter_sent">Brief versandt</option>
            <option value="paid">Bezahlt</option>
            <option value="closed">Geschlossen</option>
          </select>
          <select id="filterLocation" class="input w-auto min-w-40">
          ...
          <table class="w-full">
            <thead>
              <tr class="bg-slate-50 border-b border-slate-100">
                ...
                <th class="text-left text-xs font-semibold text-slate-500 uppercase tracking-wider px-4 py-3">Typ</th>
                <th class="text-left text-xs font-semibold text-slate-500 uppercase tracking-wider px-4 py-3">Status</th>
                <th class="text-left text-xs font-semibold text-slate-500 uppercase tracking-wider px-4 py-3">Frist</th>
    ...
    tbody.innerHTML = `
      <tr>
        <td colspan="7" class="px-6 py-12 text-center">
          <div class="text-slate-400 text-sm">Keine Fälle gefunden</div>
        </td>
      </tr>
    `;
    return;
